...
optim_clusters_sbsd <- function(sbsd_mat_file, out_mds_file = 'mds_sbsd.txt', n_clusters = 2, kmax , b_reps = 100, out_cluster_id = 'opt_clus_id_sbsd.txt', out_clus_info = 'opt_clusinfo_sbsd.txt', plot_clustering = F){
